const timeDiv = document.querySelector(".timelapse");
const timeImage = document.querySelector(".timelapse-image");
const timeText = document.querySelector(".timelapse-text");
